    ...
    bmak = bmak || {
        ...
        gd: function () {
            ...
            return s = s.slice(0, 11) + k,
                ...
                bmak.bc(),
                bmak.bmisc(),
                t + ",uaend," + bmak.xagg + "," + bmak.psub + "," + bmak.lang + "," + bmak.prod + "," + bmak.plen + "," + bmak.pen + "," + bmak.wen + "," + bmak.den + "," + bmak.z1 + "," + bmak.d3 + "," + n + "," + o + "," + m + "," + r + "," + i + "," + c + "," + b + "," + bmak.bd() + "," + a + "," + s + "," + e + ",loc:" + bmak.loc
        },
        ...
        bpd: function () {
            ...
            try {
                ...
                bmak.sensor_data = bmak.ver + "-1,2,-94,-100," + n + "-1,2,-94,-101," + i + "-1,2,-94,-105," + bmak.informinfo + "-1,2,-94,-102," + c + "-1,2,-94,-108," + bmak.kact + "-1,2,-94,-110," + bmak.mact + "-1,2,-94,-117," + bmak.tact + "-1,2,-94,-111," + bmak.doact + "-1,2,-94,-109," + bmak.dmact + "-1,2,-94,-114," + bmak.pact + "-1,2,-94,-103," + bmak.vcact + "-1,2,-94,-112," + b + "-1,2,-94,-115," + h + "-1,2,-94,-106," + d,
                    bmak.sensor_data = bmak.sensor_data + "-1,2,-94,-119," + bmak.mr + "-1,2,-94,-122," + w + "-1,2,-94,-123," + C + "-1,2,-94,-124," + j + "-1,2,-94,-126," + M + "-1,2,-94,-127," + bmak.nav_perm;
                var A = 24 ^ bmak.ab(bmak.sensor_data);
                bmak.sensor_data = bmak.sensor_data + "-1,2,-94,-70," + bmak.fpcf.fpValstr + "-1,2,-94,-80," + g + "-1,2,-94,-116," + bmak.o9 + "-1,2,-94,-118," + A + "-1,2,-94,-121,",
                    bmak.sd_debug(",s1:" + bmak.sensor_data.slice(0, 10))
            } catch (t) {
                try {
                    bmak.sd_debug(",s2:" + t),
                        bmak.sensor_data = bmak.ver + "-1,2,-94,-100," + bmak.uar() + "-1,2,-94,-120,",
                        t.stack && (bmak.sensor_data = bmak.sensor_data + t.stack.replace(/\"/g, "\\'"))
                } catch (t) {
                    bmak.sd_debug(",s3:" + t)
                }
            }
        ...
        encode: function (t) {
            ...
            return t.length % 3 == 1 && (a = bmak.gb(t, k),
                    o = a >> 2,
                    m = (3 & a) << 4,
                    b = b + c.charAt(o) + c.charAt(m) + "=="),
                t.length % 3 == 2 && (a = bmak.gb(t, k),
                    e = bmak.gb(t, k + 1),
                    o = a >> 2,
                    m = ((3 & a) << 4) + (e >> 4),
                    r = (15 & e) << 2,
        ...
        pd: function (t) {
            bmak.check_stop_protocol() && (bmak.apicall_bm(bmak.cf_url, t, bmak.patp),
        ...
        mn_s: function (t) {
            ...
            for (var v = 0; v < l; v++) {
                for (var h, g = new Array(64), w = e, y = n, C = o, j = m, M = r, h = i, E = c, S = b, _ = 0; _ < 64; _++) {
                    var x, A, L, T, P, F;
                    _ < 16 ? g[_] = u[v][_] : (x = bmak.rotate_right(g[_ - 15], 7) ^ bmak.rotate_right(g[_ - 15], 18) ^ g[_ - 15] >>> 3,
                            A = bmak.rotate_right(g[_ - 2], 17) ^ bmak.rotate_right(g[_ - 2], 19) ^ g[_ - 2] >>> 10,
                            g[_] = g[_ - 16] + x + g[_ - 7] + A),
                        A = bmak.rotate_right(M, 6) ^ bmak.rotate_right(M, 11) ^ bmak.rotate_right(M, 25),
                        L = M & h ^ ~M & E,
                        T = S + A + L + a[_] + g[_],
